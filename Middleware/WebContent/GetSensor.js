...
var callback2 = function(message) {
 ...
 var callback5 = function(message) {
	 ...
	 id = client.subscribe("/topic/Sensor1", callback1);
	 $.get("http://localhost:8088/Middleware/Controller/anmelden/2/SteuerungsMenue/Sensor1");
	 id = client.subscribe("/topic/Sensor2", callback2);
	 $.get("http://localhost:8088/Middleware/Controller/anmelden/2/SteuerungsMenue/Sensor2");
	 id = client.subscribe("/topic/Sensor3", callback3);
	 $.get("http://localhost:8088/Middleware/Controller/anmelden/2/SteuerungsMenue/Sensor3");
	 id = client.subscribe("/topic/Sensor4", callback4);
	 $.get("http://localhost:8088/Middleware/Controller/anmelden/2/SteuerungsMenue/Sensor4");
	 id = client.subscribe("/topic/Sensor5", callback5);
	 $.get("http://localhost:8088/Middleware/Controller/anmelden/2/SteuerungsMenue/Sensor5");
	 id = client.subscribe("/topic/Sensor6", callback6);
	 $.get("http://localhost:8088/Middleware/Controller/anmelden/2/SteuerungsMenue/Sensor6");
	 id = client.subscribe("/topic/Sensor7", callback7);
	 $.get("http://localhost:8088/Middleware/Controller/anmelden/2/SteuerungsMenue/Sensor7");
	 id = client.subscribe("/topic/Sensor8", callback8);
	 $.get("http://localhost:8088/Middleware/Controller/anmelden/2/SteuerungsMenue/Sensor8");
	 id = client.subscribe("/topic/Sensor8", callback9);
	 $.get("http://localhost:8088/Middleware/Controller/anmelden/2/SteuerungsMenue/Sensor9");	 
	 id = client.subscribe("/topic/Sensor8", callback10);
	 $.get("http://localhost:8088/Middleware/Controller/anmelden/2/SteuerungsMenue/Sensor10");	 

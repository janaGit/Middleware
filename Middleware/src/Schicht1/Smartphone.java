...
static Controller controller;
	...
	public static void rotation(@PathParam("name")String name,@PathParam ("x") float x,@PathParam ("y") float y,@PathParam ("z") float z){
		//Controller.queryDatabase("Update \"Smartphone\" set rotation='"+x+";"+y+";"+z+"' where  nameInput='"+name+"'", false);
